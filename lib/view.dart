...
// You can request multiple permissions at once.
        ...
        Column(
          children: [
            ...
            Text(
              (_current == null)
                  ? "0:0:0:0"
                  : (_current!.duration.toString().substring(
                      0, _current!.duration.toString().indexOf('.'))),
                    ...
                    onPressed: () async {
                      ...
                      appDirec.list().length.then((value) async {
                        ...
                        if (value > 9) {
                          ...
                          if (await Directory("${appDir!.path}/Audiorecords")
                              .exists()) {
                            await showDialog(
                              context: context,
                              builder: (BuildContext context) =>
    ...
    return StatefulBuilder(builder: (context, setState) {
      return AlertDialog(
        ...
        content: new Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: <Widget>[
            Text("Limited 10 in this version"),
          ],
        ),
        actions: <Widget>[
          new FlatButton(
  ...
  _start() async {
    ...
    new Timer.periodic(tick, (Timer t) async {
      if (_current!.duration.toString().indexOf('15') != -1) {
        t.cancel();
        await _stop();
      }
