...
class _RecordsState extends State<Records> {
                        ...
                        _Presso(
                            ...
                            onPressed: () {
                              ...
                              advancedPlayer.onAudioPositionChanged
                                  .listen((duration) {
                                    print('position');
                                    if (preduration > duration.inMicroseconds) {
                                      print('success');
                                      count++;
                                    }
                                    preduration = duration.inMicroseconds;
  ...
  String _getFileName({required String filePath}) {
    String fromPath = filePath.substring(filePath.lastIndexOf('/')+1, filePath.lastIndexOf('#'));
    if(fromPath != null) {
      return fromPath;
    }else{
      return 'No Name';
